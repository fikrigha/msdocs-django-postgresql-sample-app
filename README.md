...
| [whitenoise](https://pypi.org/project/whitenoise/) | Static file serving for WSGI applications, used in the deployed app. <br><br> This package is used in the [main/production.py](./main/production.py) file, which configures production settings. |
